<template>
  <div id="main" class="mobile">
    ...
    <div class="banner">
      <div class="top-banner" v-if="!websiteType">
        <!-- <a href="http://doc.linkease.com/zh/guide/ddnsto/"> -->
    ...
    <div class="container">
      ...
      <div class="introduction">
        <h3 class="title">
          <span class="number color-ff022a">01</span>
          无需公网
        </h3>
        <div class="desc">
          当需要外网访问设备的时候，DDNSTO无需 公网IP，不被网络环境所限制。
        </div>
      </div>
    </div>
    <div class="container">
      ...
      <div class="introduction">
        <h3 class="title">
          <span class="number color-0060ff">02</span>
          我们支持多种设备
        </h3>
        <div class="desc">
          我们支持各种设备：梅林路由器固件、OpenWrt、群晖、威联通、Docker…
        </div>
      </div>
    </div>
    <div class="container">
      ...
      <div class="introduction">
        <h3 class="title">
          <span class="number color-ff9e00">03</span>
          多种远程应用
        </h3>
        <div class="desc">
          远程登录SSH、远程桌面RDP/VNC、远程下载 aria2…
          多种远程应用只需一个浏览器。
        </div>
      </div>
    </div>
    <div class="container">
      ...
      <div class="introduction">
        <h3 class="title">
          <span class="number color-42d1c3">04</span>
          更快的响应
        </h3>
        <div class="desc">
          国内多个服务器支持，加上HTTP2.0的技术优势，
          让你拥有前所未有的远程访问体验。
        </div>
      </div>
    </div>

    <!-- <div class="prise" id="allprise1">
            <div class="tit">
...
import homeBanner from "../public/assets/home/pic_banner@2x.png";
import homeDdnsto from "../public/assets/home/pic_blue@2x.png";
  ...
  data() {
    return {
      ...
      linkList: [
        ...
        {
          text: "iStoreOS",
          url: "https://doc.linkease.com/zh/guide/ddnsto/install/device/istoreos.html",
        },

        {
          text: "OpenWRT",
          url: "https://doc.linkease.com/zh/guide/ddnsto/install/device/openwrt.html",
        },

        {
          text: "Windows",
          url: "https://doc.linkease.com/zh/guide/ddnsto/install/device/windows.html",
        },
        ...
        {
          text: "Linux",
          url: "https://doc.linkease.com/zh/guide/ddnsto/install/device/linux.html",
        },
        {
          text: "其他",
          url: "https://doc.linkease.com/zh/guide/ddnsto/support.html",
        },
      ],
    };
  },
